...
function() {
    ...
    function(e, t, n) {
        ...
        function(e, t, n, r) {
            ...
            else for (r in t) t.hasOwnProperty(r) && I(e, r, t[r]);
            return e
    ...
    function(e, t) {
        ...
        function handleJsonp(e, t, n, r) {
            var i = uniqid++,
                ...
                o = e.jsonpCallbackName || "reqwest_" + i,
                u = new RegExp("((^|\\?|&)" + s + ")=([^&]+)"),
                a = r.match(u),
                f = doc.createElement("script"),
                l = 0;
            a ? a[3] === "?" ? r = r.replace(u, "$1=" + o) : o = a[3] : r = urlappend(r, s + "=" + o), win[o] = generalCallback, f.type = "text/javascript", f.src = r, f.async = !0, typeof f.onreadystatechange != "undefined" && (f.event = "onclick", f.htmlFor = f.id = "_reqwest_" + i), f.onload = f.onreadystatechange = function() {
        ...
        function serial(e, t) {
            ...
            case "select":
                ...
                else for (var a = 0; e.length && a < e.length; a++) e.options[a].selected && i(e.options[a])
            }
        }
...
var Mustache = function() {
        ...
        if (t) n = function(e) {
            ...
            var r, i;
            /\S/.test(" ") ? (r = /^[\s\xA0]+/, i = /[\s\xA0]+$/) : (r = /^\s+/, i = /\s+$/), n = function(e) {
    ...
    e.extend = function(e, t) {
        ...
        sourceCoordinate: function(t) {
            var n = this.tileLimits[0].zoomTo(t.zoom).container(),
                r = this.tileLimits[1].zoomTo(t.zoom).container().right().down(),
                i = Math.pow(2, t.zoom),
                s;
            return t.column < 0 ? s = (t.column % i + i) % i : s = t.column % i, t.row < n.row || t.row >= r.row ? null : s < n.column || s >= r.column ? null : new e.Coordinate(t.row, s, t.zoom)
        }
...
typeof window != "undefined" && (window.html = html, window.html_sanitize = html_sanitize), html4.ATTRIBS["*::style"] = 0, html4.ELEMENTS.style = 0, html4.ATTRIBS["a::target"] = 0, html4.ELEMENTS.video = 0, html4.ATTRIBS["video::src"] = 0, html4.ATTRIBS["video::poster"] = 0, html4.ATTRIBS["video::controls"] = 0, html4.ELEMENTS.audio = 0, html4.ATTRIBS["audio::src"] = 0, html4.ATTRIBS["video::autoplay"] = 0, html4.ATTRIBS["video::controls"] = 0, wax = wax || {}, wax.attribution = function() {
    ...
    function g(e) {
        if (v()) return;
        n = !0, i = wax.u.eventoffset(e), e.type === "mousedown" ? (bean.add(document.body, "click", b), bean.add(document.body, "mouseup", b)) : e.type === "touchstart" && e.touches.length === 1 && (bean.fire(t, "off"), bean.add(f(), p))
    }
    function y() {
        bean.remove(f(), p), n = !1
    }
    function b(e) {
        ...
        return bean.remove(document.body, "mouseup", b), bean.remove(f(), p), e.type === "touchend" ? t.click(e, i) : Math.round(u.y / s) === Math.round(i.y / s) && Math.round(u.x / s) === Math.round(i.x / s) && (r = window.setTimeout(function() {
            r = null, t.click(o, u)
        }, 300)), b
    }
    var e = wax.gm(),
    ...
    return t.click = function(n, r) {
        ...
        return arguments.length ? (l = e, u && u(l), bean.add(f(), h), bean.add(f(), "touchstart", g), t) : l
    }, t.grid = function(e) {
...
wax.legend = function() {
    ...
    return t.element = function() {
        ...
        return n = document.createElement("div"), n.className = "map-legends", e = n.appendChild(document.createElement("div")), e.className = "map-legend", e.style.display = "none", t
    }, t.add()
};
var wax = wax || {};
...
wax.u = {
    offset: function(e) {
        ...
        var a = document.defaultView ? window.getComputedStyle(r.parentNode, null) : r.parentNode.currentStyle;
        return r.parentNode.offsetTop !== parseInt(a.marginTop, 10) && !isNaN(parseInt(a.marginTop, 10)) && (i += parseInt(a.marginTop, 10), s += parseInt(a.marginLeft, 10)), {
            top: i,
            left: s,
            height: n,
            width: t
    ...
    return c.addCallback = function(e, t) {
        return callbackManager.addCallback(e, t), c
    }, c.removeCallback = function(e, t) {
        return callbackManager.removeCallback(e, t), c
    }, c.extent = function(e, t) {
        if (!e) return l;
        l = [new MM.Location(Math.max(e[0].lat, e[1].lat), Math.min(e[0].lon, e[1].lon)), new MM.Location(Math.min(e[0].lat, e[1].lat), Math.max(e[0].lon, e[1].lon))], E(h), t || callbackManager.dispatchCallback("change", l)
    ...
    function u(e, t) {
        r.dimensions = new MM.Point(e, t), r.parent.style.width = Math.round(r.dimensions.x) + "px", r.parent.style.height = Math.round(r.dimensions.y) + "px", r.dispatchCallback("resized", r.dimensions)
    }
    var e = !1,
        t = {},
    ...
    return n.className = "map-fullscreen", n.href = "#fullscreen", t.map = function(e) {
        ...
        if (e) return;
        return e = !0, s = [r.parent.offsetWidth, r.parent.offsetHeight], r.parent.className += " map-fullscreen-map", i.className += " map-fullscreen-view", u(r.parent.offsetWidth, r.parent.offsetHeight), t
    }, t.original = function() {
        if (!e) return;
        return e = !1, r.parent.className = r.parent.className.replace(" map-fullscreen-map", ""), i.className = i.className.replace(" map-fullscreen-view", ""), u(s[0], s[1]), t
    }, t.element = function() {
        return n
    }, t.appendTo = function(e) {
        return wax.u.$(e).appendChild(n), t
    ...
    var e, t = {},
        n = document.createElement("div");
    n.className = "map-legends";
    var r = n.appendChild(document.createElement("div"));
    return r.className = "map-legend", r.style.display = "none", t.content = function(e) {
...
wax.mm = wax.mm || {}, wax.mm._provider = function(e) {
    ...
    var n = function() {
            ...
            function h(e, n) {
                var r = new t.Point(f.dimensions.x / 2, f.dimensions.y / 2);
                return r.x += f.tileSize.x * (n.column - e.column), r.y += f.tileSize.y * (n.row - e.row), r
            }
            var e = {},
                n = !1,
                r = !1,
            ...
            var c = {};
            c.screen = function(e, n, r) {
                var i = l(e.zoom, n.zoom, r),
                    s = e.copy(),
                    o = n.copy().zoomTo(e.zoom);
                return (new t.Coordinate(l(s.row, o.row, r), l(s.column, o.column, r), s.zoom)).zoomTo(i)
            }, c.about = function(e, t, n) {
                var r = l(e.zoom, t.zoom, n),
                    i = t.copy().zoomTo(e.zoom),
                    s = e.copy().zoomTo(r),
                    o = t.copy().zoomTo(r),
                    u = h(e, i),
                    a = h(s, o);
                return s.column -= (u.x - a.x) / f.tileSize.x, s.row -= (u.y - a.y) / f.tileSize.y, s
            };
            var p = c.screen;
            e.t = function(t) {
                return f.coordinate = p(u, a, o(t)), f.draw(), e
            }, e.future = function(e) {
                var t = [];
            ...
            return e.resetRun = function() {
                ...
                function c() {
                    ...
                    if (e > s) {
                        n = !1, f.coordinate = p(u, a, 1), a = u = undefined, f.draw();
                        if (l) return l(f)
                    } else f.coordinate = p(u, a, o(e / s)), f.draw(), t.getFrame(c)
                }
                if (n) return e.stop(function() {
                    e.run(s, l)
                });
                u || (u = f.coordinate.copy()), a || (a = f.coordinate.copy()), s = s || 1e3, d = +(new Date), n = !0, t.getFrame(c)
            }, e.optimal = function(n, r, i) {
                function s(e) {
                    return e * e
                }
                function o(e) {
                ...
                function T(e) {
                    var t = s(g) - s(m) + (e ? -1 : 1) * Math.pow(r, 4) * s(x - S),
                        n = 2 * (e ? g : m) * s(r) * (x - S);
                    return t / n
                }
                function N(e) {
                    return Math.log(-T(e) + Math.sqrt(s(T(e)) + 1))
                }
                n = n || .9, r = r || 1.42, u ? f.coordinate = u : u = f.coordinate.copy();
                var d = f.pointCoordinate(new t.Point(0, 0)).zoomTo(0),
                    v = f.pointCoordinate(f.dimensions).zoomTo(0),
                    m = Math.max(v.column - d.column, v.row - d.row),
                    g = m * Math.pow(2, u.zoom - a.zoom),
                    y = u.zoomTo(0),
                    b = a.zoomTo(0),
                    w = {
                        x: y.column,
                    ...
                    S = 0,
                    x = Math.sqrt(s(E.x - w.x) + s(E.y - w.y)),
                    C = N(0),
                    k = N(1),
                    L = (k - C) / r,
                    A = function(e) {
                        return m * c(C) / c(r * e + C)
                    },
                    O = function(e) {
                        return m / s(r) * c(C) * h(r * e + C) - m / s(r) * o(C) + S
                    };
                if (Math.abs(x) < 1e-6) {
                    if (Math.abs(m - g) < 1e-6) return;
                    var M = g < m ? -1 : 1;
                    L = Math.abs(Math.log(g / m)) / r, O = function(e) {
                        return S
                    }, A = function(e) {
                        return m * Math.exp(M * r * e)
                    }
                }
                var _ = p;
                p = function(e, n, r) {
                    ...
                    var i = r * L,
                        s = O(i),
                        o = e.zoom + Math.log(m / A(i)) / Math.LN2,
                        u = l(w.x, E.x, s / x || 1),
                        f = l(w.y, E.y, s / x || 1);
                    return (new t.Coordinate(f, u, 0)).zoomTo(o)
                }, e.run(L / n * 1e3, function(e) {
                    p = _, i && i(e)
                })
            }, e
        };
    ...
    n.TouchHandler = function() {
        function g(e) {
            var i = {
                ...
                o = Math.max(.001, (e - r) / 1e3);
            p && d && v > +(new Date) - 50 ? (i.x = p.x - d.x, i.y = p.y - d.y, s.x = i.x, s.y = i.y) : (s.x -= s.x * f, s.y -= s.y * f, Math.abs(s.x) < .001 && (s.x = 0), Math.abs(s.y) < .001 && (s.y = 0)), (s.x || s.y) && n.panBy(s.x, s.y), r = e, t.getFrame(g)
        }
        function y(e, t) {
            return e && e.touch && t.identifier == e.touch.identifier
        }
        function b(e) {
            for (var t = 0; t < e.touches.length; t += 1) {
                var n = e.touches[t];
                if (n.identifier in l) {
                    var r = l[n.identifier];
                    r.x = n.clientX, r.y = n.clientY, r.scale = e.scale
                } else l[n.identifier] = {
                    scale: e.scale,
                    startPos: {
        ...
        function C(e) {
            var r = e.touches[0],
                i = e.touches[1],
                s = new t.Point(r.clientX, r.clientY),
                o = new t.Point(i.clientX, i.clientY),
                u = l[r.identifier],
                a = l[i.identifier];
            u.wasPinch = !0, a.wasPinch = !0;
            var f = t.Point.interpolate(s, o, .5);
            n.zoomByAbout(Math.log(e.scale) / Math.LN2 - Math.log(u.scale) / Math.LN2, f);
            var c = t.Point.interpolate(u, a, .5);
            n.panBy(f.x - c.x, f.y - c.y), h = !0, m = f
        }
        function k(e) {
            var t = n.getZoom(),
                r = Math.round(t);
            n.zoomByAbout(r - t, e), h = !1
        }
        function L(e) {
            var n = (new Date).getTime();
            e.touches.length === 0 && h && k(m), d = p = null;
            for (var r = 0; r < e.changedTouches.length; r += 1) {
                var i = e.changedTouches[r],
                    s = l[i.identifier];
                if (!s || s.wasPinch) continue;
                var a = {
                    x: i.clientX,
                    y: i.clientY
                },
                    f = n - s.time,
                    c = t.Point.distance(a, s.startPos);
                c > u || (f > o ? (a.end = n, a.duration = f, onHold(a)) : (a.time = n, S(a)))
            }
            var v = {};
            for (var g = 0; g < e.touches.length; g++) v[e.touches[g].identifier] = !0;
            for (var y in l) y in v || delete v[y];
        ...
        return e.init = function(e) {
            n = e;
            if (!T()) return !1;
            t.addEvent(n.parent, "touchstart", w), t.addEvent(n.parent, "touchmove", E), t.addEvent(n.parent, "touchend", L), r = (new Date).getTime(), s = {
                x: 0,
                y: 0
            }, t.getFrame(g)
        }, e.remove = function() {
            if (!T()) return !1;
            t.removeEvent(n.parent, "touchstart", w), t.removeEvent(n.parent, "touchmove", E), t.removeEvent(n.parent, "touchend", L)
        }, e
        ...
        function v(e) {
            ...
            return t.addEvent(document, "mousemove", m), t.addEvent(document, "mouseup", g), f = l = t.getMousePoint(e, n), c = h = +(new Date), n.parent.style.cursor = "move", t.cancelEvent(e)
        }
        function m(e) {
            if (f) return p && (l = f, h = c, p = !1), f = t.getMousePoint(e, n), c = +(new Date), t.cancelEvent(e)
        }
        function g(e) {
            t.removeEvent(document, "mousemove", m), t.removeEvent(document, "mouseup", g);
            if (+(new Date) - h < 50) {
                dt = Math.max(1, c - h);
                var r = {
                    x: 0,
                ...
                r.x = f.x - l.x, r.y = f.y - l.y, i.x = r.x / dt, i.y = r.y / dt
            } else i.x = 0, i.y = 0;
            return f = l = null, c = lastMoveTime = null, n.parent.style.cursor = "", t.cancelEvent(e)
        }
        function y(e) {
            var u = {
                x: 0,
                ...
                a = Math.max(1, e - r);
            f && l ? p || (u.x = f.x - l.x, u.y = f.y - l.y, n.panBy(u.x, u.y), p = !0) : (i.x *= Math.pow(1 - s, a * 60 / 1e3), i.y *= Math.pow(1 - s, a * 60 / 1e3), Math.abs(i.x) < .001 && (i.x = 0), Math.abs(i.y) < .001 && (i.y = 0), (i.x || i.y) && n.panBy(i.x * a, i.y * a)), r = e, o || t.getFrame(y)
        }
        var e = {},
            n, r = 0,
            i = null,
            ...
            p = !0;
        return e.init = function(e) {
            n = e, t.addEvent(n.parent, "click", d), t.addEvent(n.parent, "mousedown", v), r = (new Date).getTime(), i = {
                x: 0,
                y: 0
            }, o = !1, t.getFrame(y)
        }, e.remove = function() {
            t.removeEvent(n.parent, "click", d), t.removeEvent(n.parent, "mousedown", v), o = !0
        }, e
    ...
    return e.parent = document.createElement("div"), e.parent.style.cssText = "position: absolute; top: 0px;left:0px; width:100%; height:100%; margin:0; padding:0; z-index:0;pointer-events:none;", e.name = "markers", e.addCallback = function(t, n) {
        ...
        function r(t, r) {
            if (t && n) return n(t);
            r && r.features && e.features(r.features), n && n(t, r.features, e)
        }
        ...
        return typeof t == "string" && (t = [t]), u = t, reqwest(u[0].match(/geojsonp$/) ? {
            url: u[0] + (~u[0].indexOf("?") ? "&" : "?") + "callback=grid",
            type: "jsonp",
            jsonpCallback: "callback",
            success: function(e) {
                r(null, e)
    ...
    t.formatter = function(e) {
        ...
        for (var t = 0; t < f.length; t++) delete f[t].clicked
        ...
        var a = function() {
            ...
            f = function(f) {
                ...
                c.className = "marker-tooltip", c.style.width = "100%";
                var h = c.appendChild(document.createElement("div"));
                h.style.cssText = "position: absolute; pointer-events: none;";
                var p = h.appendChild(document.createElement("div"));
                p.className = "marker-popup", p.style.cssText = "pointer-events: auto;", typeof l == "string" ? p.innerHTML = l : p.appendChild(l), h.style.bottom = i.element.offsetHeight / 2 + 20 + "px", s && (c.onmouseover = function() {
                ...
                n.push(d), e.add(d), e.draw()
            };
        i.element.onclick = i.element.ontouchstart = function() {
            f(), i.clicked = !0
        }, s && (i.element.onmouseover = f, i.element.onmouseout = a)
    };
    if (e) {
        e.addCallback("drawn", a), e.removeCallback("drawn", a);
        var f = e.markers();
        for (var l = 0; l < f.length; l++) t.bindMarker(f[l]);
...
}, typeof mapbox == "undefined" && (mapbox = {}), mapbox.map = function(e, t, n, r) {
    ...
    i.setZoomRange(0, 17), i.ease = easey().map(i), i.ui = mapbox.ui(i), i.interaction = mapbox.interaction().map(i), i.auto = function() {
        this.ui.zoomer.add(), this.ui.zoombox.add(), this.interaction.auto();
    ...
    return MM.Map.prototype.smooth = function(e) {
        ...
        return e instanceof MM.Extent && (e = e.toArray()), this.coordLimits = [this.locationCoordinate(e[0]).zoomTo(this.coordLimits[0].zoom), this.locationCoordinate(e[1]).zoomTo(this.coordLimits[1].zoom)], i
    ...
    e.indexOf("http") !== 0 && (e = "http://a.tiles.mapbox.com/v3/" + e + ".jsonp"), wax.tilejson(e, function(e) {
        e.zoom = e.center[2], e.center = {
            lat: e.center[1],
            lon: e.center[0]
        }, e.thumbnail = "http://a.tiles.mapbox.com/v3/" + e.id + "/thumb.png", e.layer = mapbox.layer().tilejson(e), e.data ? (e.markers = mmg().factory(mapbox.markers.simplestyle_factory), e.markers.url(e.data, function() {
            mmg_interaction(e.markers), t(e)
        })) : t(e)
    })
    ...
    return wax.tilejson(this._url, function(n) {
        t.tilejson(n), e && e(this)
    }), this
}, mapbox.layer.prototype.url = function(e, t) {
    return arguments.length ? (this._url = e, this.refresh(t)) : this._url
}, mapbox.layer.prototype.id = function(e, t) {
    return arguments.length ? (this.url("http://a.tiles.mapbox.com/v3/" + e + ".jsonp"), this.named(e), this._id = e, this.refresh(t)) : this._id
    ...
    this.setProvider(new wax.mm._provider(e)), this._tilejson = e, this.name = this.name || e.id, this._id = this._id || e.id;
    if (e.bounds) {
    ...
    if (this._composite) {
        ...
        if (this.compositeLayer !== n) {
            ...
            var s = this;
            return mapbox.load(n, function(e) {
                s.setProvider(new wax.mm._provider(e))
            }), this.parent.style.display = "", this
        }
    } else this.parent.style.display = "", this.compositeLayer && (this.compositeLayer = !1, this.tilejson(this.tilejson()));
    ...
    MM.Layer.prototype.enable.call(this, e), this.map.draw()
}, mapbox.layer.prototype.disable = function(e) {
    MM.Layer.prototype.disable.call(this, e), this.map.draw()
    ...
    return e.refresh = function() {
        ...
        return t = !0, e.on(wax.tooltip().animate(!0).parent(e.map().parent).events()), e.refresh()
    }, e
